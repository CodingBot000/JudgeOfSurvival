export const templatesKo = {
  ...
  "power.hidden_food.1": {
    parts: [
      "{targetName}의 자리 아래로 작은 비상식량 꾸러미가 밀려 들어갑니다.",
      "{targetName}은 그것을 보자마자 손을 멈추지만, 눈은 이미 계산하고 있습니다.",
    ],
  },
  "power.hidden_food.2": {
    parts: [
  ...
  "minor.whisper_fear.2": {
    parts: [
      "{targetName}의 눈이 흔들립니다. 방금 전까지 같은 편이던 얼굴들이 낯설어집니다.",
      "말은 없지만, 손가락은 가장 가까운 물건을 찾습니다.",
    ],
  },
  "minor.nudge_greed.1": {
    parts: [
  ...
  "minor.seed_doubt.1": {
    parts: [
      "{targetName}을 둘러싼 의심이 천천히 모양을 갖춥니다.",
      "아무도 먼저 말하지 않습니다. 하지만 아무도 그 옆에 앉으려 하지 않습니다.",
    ],
  },
  "minor.seed_doubt.2": {
    parts: [
  ...
  "event.hidden_resource_found.1": {
    parts: [
      "{targetName}이 숨기던 보급품이 젖은 천 아래에서 드러납니다.",
      "{targetName}: 지금 쓰면 다 끝나. 나는 그걸 막으려던 것뿐이야.",
    ],
  },
  ...
  "event.exile_the_weak.1": {
    parts: [
      "{actorName}이 가장 오래 침묵한 뒤 {targetName} 쪽을 봅니다.",
      "{actorName}: {opener}. 지금은 누가 버틸 수 있는지 봐야 해.",
    ],
  },
  ...
  "event.secret_water_drinking.1": {
    parts: [
      "{actorName}이 고개를 돌린 사이 {riskNoun}에 입을 댑니다.",
      "{actorName}: 내가 쓰러지면 더 큰 문제가 생겨. 필요한 만큼만 마신 거야.",
    ],
  },
  ...
  "event.nurse_protects.1": {
    parts: [
      "{actorName}이 떨리는 손으로 {targetName}을 붙잡습니다.",
      "{actorName}: 아직 돌볼 수 있어요. 우리가 그걸 포기하면 정말 끝이에요.",
    ],
  },
  ...
  "event.stowaway_witch_hunt.1": {
    parts: [
      "의심이 다시 {targetName}에게 향합니다. 밀항자라는 말이 파도보다 차갑게 떠돕니다.",
      "{targetName}: 또 나야? 내가 여기 있다는 이유만으로?",
    ],
  },
  ...
  "event.boat_damage.2": {
    parts: [
      "보트가 파도 위에서 비틀립니다. 갈라진 곳이 더 벌어지고, {groupName}의 얼굴에서 색이 빠집니다.",
      "아무도 책임을 묻지 않았지만 모두가 누군가를 떠올립니다.",
    ],
  },
  ...
  "event.rescue_signal.1": {
    parts: [
      "파도 너머로 작은 빛이 나타납니다. 너무 멀지만, 분명히 움직이고 있습니다.",
      "{groupName}은 처음으로 같은 방향을 봅니다.",
    ],
  },
  "event.rescue_signal.2": {
    parts: [
      "먼 불빛 하나가 어둠을 가릅니다. 구조인지 착각인지 아직 알 수 없습니다.",
      "그래도 그 빛은 보트 위의 시간을 잠시 멈춥니다.",
    ],
  },
  "event.silent_turn.1": {
    parts: [
  ...
  "event.public_accusation.3": {
    parts: [
      "보트 위의 시선이 {targetName}에게 모입니다. {actorName}이 그 침묵을 놓치지 않습니다.",
      "{actorName}: 지금 망설이면 모두가 같이 끝나.",
    ],
  },
